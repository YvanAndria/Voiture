...
class VoituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voiture" do
    assert_difference("Voiture.count") do
      post voitures_url, params: { voiture: { description: @voiture.description, image: @voiture.image, location: @voiture.location, model: @voiture.model, title: @voiture.title } }
    end
  ...
  test "should update voiture" do
    patch voiture_url(@voiture), params: { voiture: { description: @voiture.description, image: @voiture.image, location: @voiture.location, model: @voiture.model, title: @voiture.title } }
